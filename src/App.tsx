...
import { Heart, Phone, Clock, DollarSign, Users, Coffee, CheckCircle, Star, ArrowRight, Instagram, Facebook } from 'lucide-react';
  ...
  return (
    <div className="font-sans max-w-full mx-auto">
      ...
      <section className="relative w-full">
        <div className="absolute inset-0 bg-cover bg-center w-full" style={{ 
        ...
        <div className="relative container mx-auto px-6 md:px-8 pt-4 md:pt-6">
          <div className="flex items-center">
            <img src="https://i.imgur.com/6BRJU5Q.png" alt="Haybales & Chandeliers Logo" className="h-12 md:h-16" />
          </div>
        </div>
        <div className="relative container mx-auto px-6 md:px-8 py-16 md:py-24 lg:py-32 flex flex-col items-center text-center min-h-[90vh] md:min-h-0 justify-center">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-white mb-4 md:mb-6 max-w-4xl">
            Your Vision Brought to Life – Without the Stress (or the Huge Price Tag)
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="order-1 md:order-1">
              ...
              <div className="flex flex-wrap justify-center gap-6">
                <div className="bg-white p-3 shadow-md rounded-sm transform rotate-1 transition-all duration-300 hover:rotate-0 hover:shadow-lg" style={{ maxWidth: '220px' }}>
                  <img 
                    src="https://i.imgur.com/pO32mNP.jpeg" 
                    alt="Wedding Setup" 
                ...
                <div className="bg-white p-3 shadow-md rounded-sm transform -rotate-1 transition-all duration-300 hover:rotate-0 hover:shadow-lg" style={{ maxWidth: '220px' }}>
                  <img 
                    src="https://i.imgur.com/VtpOnNz.jpeg" 
            ...
            <div className="flex flex-col justify-center order-2 md:order-2">
              ...
              <p className="text-lg md:text-xl text-gray-700 mb-4">
                From intimate ceremonies to GRAND celebrations, we've helped brides bring their DREAM weddings to life. ✨
              </p>
              <p className="text-lg md:text-xl text-gray-700">
                Every detail, from decor to coordination, is handled with care. 
                So you can RELAX and get that candid picture of you walking towards the stage, while everybody looks at you in awe. 💖
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div className="bg-[#ebd2cd] bg-opacity-20 p-6 rounded-lg text-center hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-700">Personal touch, not a big corporate service.</p>
            </div>
            ...
            <div className="bg-[#ebd2cd] bg-opacity-20 p-6 rounded-lg text-center hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-700">No hidden fees, full clarity upfront.</p>
            </div>
            ...
            <div className="bg-[#ebd2cd] bg-opacity-20 p-6 rounded-lg text-center hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-700">Over 200 happy couples planned in Gloucestershire.</p>
            </div>
            ...
            <div className="bg-[#ebd2cd] bg-opacity-20 p-6 rounded-lg text-center hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-700">We handle everything, so you don't have to.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-lg text-gray-700 mb-4">
                "All our guests all commented on how beautiful our venue looked. If you are thinking of booking these guys, don't hesitate as you will not be disappointed. Punctual, friendly & approachable"
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="text-sm text-gray-500">Helen Sullivan, 2020</div>
              </div>
              <p className="text-lg text-gray-700 mb-4">
                "They will go above and beyond to meet all your needs and desires. Loved it!!!"
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#ebd2cd] bg-opacity-10 py-16">
        <div className="container mx-auto px-6 md:px-8">
          ...
          <p className="text-center text-gray-700 max-w-2xl mx-auto mb-12">
            Book your free consultation today and receive these exclusive benefits
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="text-xl font-medium mb-3">FREE Wedding Planning Session</h3>
              <p className="text-gray-700">A full hour of personalized planning with our expert team.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="text-xl font-medium mb-3">FREE Gloucestershire Vendor Guide</h3>
              <p className="text-gray-700">Includes top vendors, best deals & a comprehensive planning checklist.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="text-xl font-medium mb-3">Exclusive Booking Bonus</h3>
              <p className="text-gray-700">Choose between a Free Audio Guestbook OR 20% Blue Light Discount on ALL Decor Rentals.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="bg-[#ebd2cd] bg-opacity-10 p-6 rounded-lg">
                <h3 className="text-2xl font-medium mb-4">Wedding Planning Services</h3>
                <p className="text-lg mb-4">Ranging from <span className="font-bold">£750 - £3000</span></p>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <CheckCircle size={20} className="text-[#ebd2cd] mr-2 mt-1 flex-shrink-0" />
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex">
                  ...
                  <div>
                    <h3 className="text-xl font-medium mb-2">Book Free Planning Session</h3>
                    <p className="text-gray-700">No pressure, just guidance! We'll listen to your vision and ideas.</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div>
                    <h3 className="text-xl font-medium mb-2">We Plan Everything Together</h3>
                    <p className="text-gray-700">Ideas, vendors, & decor sorted! We'll create a comprehensive plan.</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div>
                    <h3 className="text-xl font-medium mb-2">Road to the big day</h3>
                    <p className="text-gray-700">Changes, Confirmations, Coordination - we handle it all!</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div>
                    <h3 className="text-xl font-medium mb-2">You Relax While We Bring Your Dream to Life</h3>
                    <p className="text-gray-700">We handle everything! You focus on enjoying your special day.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="bg-[#ebd2cd] bg-opacity-20 py-16">
        <div className="container mx-auto px-6 md:px-8">
          ...
          <p className="text-center text-gray-700 max-w-3xl mx-auto mb-12">
            Planning a wedding is stressful, but finding the perfect decor doesn't have to be. We offer stunning decor to bring your vision to life—all at affordable prices.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
              <img 
                src="https://i.imgur.com/jLeVfpY.jpeg" 
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
              <img 
                src="https://i.imgur.com/57N4FFl.jpeg" 
        ...
        <div className="container mx-auto px-6 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="bg-[#ebd2cd] bg-opacity-20 p-8 rounded-lg shadow-md">
              <h3 className="text-2xl font-serif font-bold mb-4 text-center">Budget</h3>
              <ul className="space-y-2 mb-6">
                <li className="flex items-start">
                  <CheckCircle size={18} className="text-black mr-2 mt-1 flex-shrink-0" />
            ...
            <div className="bg-black text-white p-8 rounded-lg shadow-md">
              <h3 className="text-2xl font-serif font-bold mb-4 text-center">Premium</h3>
              <ul className="space-y-2 mb-6">
                <li className="flex items-start">
                  <CheckCircle size={18} className="text-[#ebd2cd] mr-2 mt-1 flex-shrink-0" />
                ...
                <li className="flex items-start">
                  <CheckCircle size={18} className="text-[#ebd2cd] mr-2 mt-1 flex-shrink-0" />
                  <span>Additional 2 Hours Full Sized Magic Mirror for £175</span>
                </li>
              </ul>
              <div className="text-center mb-6">
      ...
      <section className="bg-[#ebd2cd] py-16">
        <div className="container mx-auto px-6 md:px-8 text-center">
          ...
          Take the First Step to Bring Your Vision to Life         </p>
          <div className="flex flex-col items-center">
            <a 
              href="tel:+447368203447" 
        ...
        <div className="container mx-auto px-6 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <img src="https://i.imgur.com/6BRJU5Q.png" alt="Haybales & Chandeliers Logo" className="h-12 mb-4" />
              <p className="text-sm text-gray-400">
                Over 200 Dream Weddings Brought to Life.
              </p>
              <div className="flex mt-4 space-x-4">
                <a href="https://www.instagram.com/haybalesandchandeliers" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#ebd2cd] transition-colors">
                  <Instagram size={20} />
                </a>
                <a href="https://www.facebook.com/HaybalesAndChandeliers/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#ebd2cd] transition-colors">
                  <Facebook size={20} />
                </a>
              </div>
            </div>
            <div className="text-center md:text-right">
              <p className="mb-2">
                <a href="tel:+447368203447" className="text-[#ebd2cd] hover:underline">+44 7368 203447</a>
              </p>
              <p className="text-sm text-gray-400 mb-2">
                © 2025 Haybales & Chandeliers. All rights reserved.
              </p>
              <p className="text-sm text-gray-400">
                <a href="https://www.freeprivacypolicy.com/live/aba10e91-e336-4056-af89-7c2f9d21690a" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#ebd2cd] transition-colors">
                  Privacy Policy
                </a>
              </p>
            </div>
